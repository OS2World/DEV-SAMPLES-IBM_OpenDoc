 ...
 */
/* @(#) 1.2 com/src/samples/dynamicp/bregist/rgetphnm.c, oddynamicpart, od96os2, odos29712d 97/03/21 17:44:49 (96/11/01 08:50:31)
*******************************************************************
...
*/
{
   ...
   strcpy (HandlerName, kPartHandlerName);   // Defined in rTypeStr.h
   return HandlerName;
} // end rGetPhNm.c
