/* @(#) 1.17 com/src/storage/LinkSrcB.cpp, oddataxfer, od96os2, odos29712d 3/7/97 11:16:27 [3/21/97 17:18:55] */
...
#endif
		ODWindow* activeWindow = session->GetWindowState(ev)->AcquireActiveWindow(ev);
#if defined(_PLATFORM_WIN32_) || defined(_PLATFORM_OS2_)
                result = ShowLinkSourceInfo(somSelf,
                                            change,
                                            changesAllowed,
					    activeWindow->GetPlatformWindow(ev),
                                            facet,
                                            infoResult);
