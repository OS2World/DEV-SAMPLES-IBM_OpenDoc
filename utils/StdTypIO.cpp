...
//
// @(#) 1.38 com/src/utils/StdTypIO.cpp, odmri, od96os2, odos29712d 1/28/97 15:20:17 [ 3/21/97 17:20:57 ]
            ...
            ODIText* iText)
{
   ...
   if (tradMacTextExists)
   {
      ...
      if (tradMacTextExists) {
        ...
        format = ConvertODULongFromStd(format);
         ...
         ODIText* iText)
{
   ...
   ODITextFormat format = iText->format;
   format = ConvertODULongToStd(format);
   StorageUnitSetValue(su, ev,  sizeof(ODITextFormat),  (ODValue)&format);
#ifdef _UNICODE_
