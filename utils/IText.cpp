...
//
// @(#) 1.22 com/src/pubutils/src/IText.cpp, odmri, od96os2, odos29712d 12/3/96 16:33:31 [ 3/21/97 17:21:16 ]
/*
   File:    IText.cpp
...
WIN32_DLLEXPORT ODIText*        CreateITextFromCharPtr(char* text)
{
    ...
    if (rc == NO_ERROR) {
      scriptCode = aulCpList[0]; // primary code page is index 0
    } else {
      scriptCode = 0;  // It's not bad enough to stop.
    }
