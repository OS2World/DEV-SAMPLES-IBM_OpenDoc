/* @(#)Z 1.52 com/src/docshell/ODShell.cpp, odshell, od96os2, odos29712d 97/03/21 17:37:27 (97/03/19 09:45:01) */
							...
							DocumentManager *docMgr)
{
    ...
    try
    {
        if (docMgr == _fActiveDocumentManager)
            _fActiveDocumentManager = (DocumentManager *)kODNULL;
