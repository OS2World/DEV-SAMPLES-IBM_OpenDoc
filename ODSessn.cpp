...
//
/* @(#) 1.30 com/src/core/ODSessn.cpp, odcore, od96os2, odos29712d 3/11/97 09:11:43 [3/21/97 17:18:08] */
/*
        File:           ODSessn.cpp
...
SOM_Scope ODPartHandlerRegistryInt*  SOMLINK ODSessionGetRegistry
		(ODSession *somSelf, Environment *ev)
{
    ODSessionData *somThis = ODSessionGetData(somSelf);
    ODSessionMethodDebug("ODSession","GetRegistry");
...
SOM_Scope void  SOMLINK ODSessionSetRegistry
		(ODSession *somSelf, Environment *ev,
		ODPartHandlerRegistryInt* registry)
{
    ODSessionData *somThis = ODSessionGetData(somSelf);
    ODSessionMethodDebug("ODSession","ODSessionSetRegistry");
