/* @(#)Z 1.12 os2/src/ui/MenuAdO.cpp, odui, od96os2, odos29712d 97/03/21 17:47:44 (97/03/20 16:08:19) */
         ...
         nextAd = (ODOS2MenuItemAdapter*) iter.Next())
    {
         if (nextAd->id == id)
	 {
	     *itemAd = nextAd;
         ...
         else if ( nextAd->subMenuAdapter ) 
         {
             found = (nextAd->subMenuAdapter)->GetMenuItemAdapter( ev, id, itemAd );
         }
    }
