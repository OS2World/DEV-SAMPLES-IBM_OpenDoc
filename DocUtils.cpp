...
//
// @(#) 1.13 com/src/utils/DocUtils.cpp, odutils, od96os2, odos29712d 12/17/96 13:54:42 [ 3/21/97 17:20:51 ]
/*
	File:		DocUtils.cpp
...
void ODResetDateModByInfo(Environment* ev, ODStorageUnit* su)
{
	...
	if (ODObjectsAreEqual(ev, su, rootSU))
	{
		...
		ODSetITextProp(ev, su, kODPropName, kODPlatformIText, partname);
