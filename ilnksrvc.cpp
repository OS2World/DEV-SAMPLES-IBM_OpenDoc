/* @(#)Z 1.14 os2/src/storage/ilnksrvc.cpp, oddataxfer, od96os2, odos29712d 97/03/21 17:40:38 (97/03/20 08:41:05) */
...
const  ODValueType  kODLengthPrefixStr           = "+//ISO 9070/ANSI::113722::US::CI LABS::OpenDoc:Type:LengthPrefixStr";
//==============================================================================
// Constants
//==============================================================================
...
char* GetPathName (char* docName)
{
    ...
    // To eliminate the popup for drive not ready
    // defect 25874
                             ...
                             ODISOStr myISOStr)
{
    ...
    //---<1>
// defect 27438
    ODSUForceFocus(ev, su, prop, kODLengthPrefixStr);
                    ...
                    ODISOStr *myISOStr)
{
    ...
    //---<1>
// defect 27438
    if (ODSUExistsThenFocus(ev, su, prop, kODLengthPrefixStr))
    {
        //---<2>
...
SOM_TRY
  ...
  //---<5> 
  // defect 27867 - defect 27438 was incomplete. rrk 20mar97 
  if (isNew || !suDraftProperties->Exists(ev, kODPropASName, kODLengthPrefixStr, 0))  
  {
    char            hostName[256];
    char            asName[256];
